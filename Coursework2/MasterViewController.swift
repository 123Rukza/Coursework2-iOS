...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if tableView.isEditing {
            ...
            let destination = storyboard?.instantiateViewController(withIdentifier: "projectPopUp") as! ProjectPopupViewController
            
            destination.isUpdate = true
            destination.updateProject = row
    ...
    func configureCell(_ cell: UITableViewCell, withProject project: Project) {
        ...
        cell.detailTextLabel!.text = "Due on " + project.due!.description.prefix(19)
    }
